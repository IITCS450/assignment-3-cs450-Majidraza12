...
80100268:	5d                   	pop    %ebp
  release(&bcache.lock);
80100269:	e9 32 43 00 00       	jmp    801045a0 <release>
    panic("brelse");
...
801005cb:	e8 30 40 00 00       	call   80104600 <acquire>
  for(i = 0; i < n; i++)
...
80100604:	e8 97 3f 00 00       	call   801045a0 <release>
  ilock(ip);
80100609:	58                   	pop    %eax
...
801007d8:	e8 23 3e 00 00       	call   80104600 <acquire>
  if (fmt == 0)
...
801007fb:	e8 a0 3d 00 00       	call   801045a0 <release>
...
801008b3:	e8 48 3d 00 00       	call   80104600 <acquire>
  while((c = getc()) >= 0){
...
801008ed:	e8 ae 3c 00 00       	call   801045a0 <release>
  if(doprocdump) {
...
80100cca:	e8 21 3c 00 00       	call   801048f0 <strlen>
...
80100cd8:	83 e3 fc             	and    $0xfffffffc,%ebx
    if(copyout(pgdir, sp, argv[argc], strlen(argv[argc]) + 1) < 0)
80100cdb:	e8 10 3c 00 00       	call   801048f0 <strlen>
...
80100d9f:	e8 0c 3b 00 00       	call   801048b0 <safestrcpy>
  curproc->pgdir = pgdir;
...
80100e61:	e8 9a 37 00 00       	call   80104600 <acquire>
...
80100e91:	e8 0a 37 00 00       	call   801045a0 <release>
      return f;
    }
  }
  release(&ftable.lock);
...
80100eaa:	e8 f1 36 00 00       	call   801045a0 <release>
}
...
80100ecf:	e8 2c 37 00 00       	call   80104600 <acquire>
  if(f->ref < 1)
...
80100eec:	e8 af 36 00 00       	call   801045a0 <release>
  return f;
}
...
80100f21:	e8 da 36 00 00       	call   80104600 <acquire>
  if(f->ref < 1)
...
80100f5c:	e8 3f 36 00 00       	call   801045a0 <release>
...
80100f8d:	5d                   	pop    %ebp
    release(&ftable.lock);
80100f8e:	e9 0d 36 00 00       	jmp    801045a0 <release>
...
801012cd:	e8 2e 34 00 00       	call   80104700 <memset>
  log_write(bp);
...
8010130a:	e8 f1 32 00 00       	call   80104600 <acquire>
  for(ip = &icache.inode[0]; ip < &icache.inode[NINODE]; ip++){
...
80101377:	e8 24 32 00 00       	call   801045a0 <release>
...
801013a5:	e8 f6 31 00 00       	call   801045a0 <release>
      return ip;
...
80101561:	e8 2a 32 00 00       	call   80104790 <memmove>
  brelse(bp);
...
80101596:	e8 75 2e 00 00       	call   80104410 <initlock>
  for(i = 0; i < NINODE; i++) {
...
801015a9:	81 c3 90 00 00 00    	add    $0x90,%ebx
    initsleeplock(&icache.inode[i].lock, "inode");
801015af:	e8 2c 2d 00 00       	call   801042e0 <initsleeplock>
  for(i = 0; i < NINODE; i++) {
...
801015dc:	e8 af 31 00 00       	call   80104790 <memmove>
  brelse(bp);
...
801016ae:	e8 4d 30 00 00       	call   80104700 <memset>
      dip->type = type;
...
80101751:	e8 3a 30 00 00       	call   80104790 <memmove>
  log_write(bp);
...
8010177f:	e8 7c 2e 00 00       	call   80104600 <acquire>
  ip->ref++;
80101784:	83 43 08 01          	addl   $0x1,0x8(%ebx)
  release(&icache.lock);
80101788:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
8010178f:	e8 0c 2e 00 00       	call   801045a0 <release>
}
...
801017c2:	e8 59 2b 00 00       	call   80104320 <acquiresleep>
  if(ip->valid == 0){
...
80101838:	e8 53 2f 00 00       	call   80104790 <memmove>
    brelse(bp);
...
80101893:	e8 28 2b 00 00       	call   801043c0 <holdingsleep>
...
801018ae:	5d                   	pop    %ebp
  releasesleep(&ip->lock);
801018af:	e9 cc 2a 00 00       	jmp    80104380 <releasesleep>
    panic("iunlock");
...
801018e0:	e8 3b 2a 00 00       	call   80104320 <acquiresleep>
...
801018fa:	e8 81 2a 00 00       	call   80104380 <releasesleep>
  acquire(&icache.lock);
801018ff:	c7 04 24 60 f9 10 80 	movl   $0x8010f960,(%esp)
80101906:	e8 f5 2c 00 00       	call   80104600 <acquire>
  ip->ref--;
...
80101a43:	e8 78 29 00 00       	call   801043c0 <holdingsleep>
...
80101a5a:	e8 21 29 00 00       	call   80104380 <releasesleep>
  iput(ip);
...
80101b57:	e8 34 2c 00 00       	call   80104790 <memmove>
    brelse(bp);
...
80101c55:	e8 36 2b 00 00       	call   80104790 <memmove>
    log_write(bp);
...
80101cde:	e8 1d 2b 00 00       	call   80104800 <strncmp>
}
80101ce3:	c9                   	leave
80101ce4:	c3                   	ret
...
80101d3d:	e8 be 2a 00 00       	call   80104800 <strncmp>
      continue;
...
80101e37:	e8 54 29 00 00       	call   80104790 <memmove>
...
80101eeb:	e8 a0 28 00 00       	call   80104790 <memmove>
    name[len] = 0;
...
80101f25:	e8 96 24 00 00       	call   801043c0 <holdingsleep>
...
80101f3c:	e8 3f 24 00 00       	call   80104380 <releasesleep>
  iput(ip);
...
80101f75:	e8 46 24 00 00       	call   801043c0 <holdingsleep>
...
80101f8c:	e8 ef 23 00 00       	call   80104380 <releasesleep>
}
...
8010201d:	e8 2e 28 00 00       	call   80104850 <strncpy>
  de.inum = inum;
...
801021b0:	e8 5b 22 00 00       	call   80104410 <initlock>
...
8010223e:	e8 bd 23 00 00       	call   80104600 <acquire>
...
8010229d:	e8 9e 1e 00 00       	call   80104140 <wakeup>
...
801022bb:	e8 e0 22 00 00       	call   801045a0 <release>
...
801022de:	e8 dd 20 00 00       	call   801043c0 <holdingsleep>
...
80102318:	e8 e3 22 00 00       	call   80104600 <acquire>
...
80102359:	e8 22 1d 00 00       	call   80104080 <sleep>
  while((b->flags & (B_VALID|B_DIRTY)) != B_VALID){
...
80102375:	c9                   	leave
  release(&idelock);
80102376:	e9 25 22 00 00       	jmp    801045a0 <release>
...
801024d2:	e8 29 22 00 00       	call   80104700 <memset>
...
80102508:	e8 f3 20 00 00       	call   80104600 <acquire>
...
80102522:	c9                   	leave
    release(&kmem.lock);
80102523:	e9 78 20 00 00       	jmp    801045a0 <release>
    panic("kfree");
...
80102605:	e8 06 1e 00 00       	call   80104410 <initlock>
  p = (char*)PGROUNDUP((uint)vstart);
...
80102698:	e8 63 1f 00 00       	call   80104600 <acquire>
  r = kmem.freelist;
...
801026c3:	e8 d8 1e 00 00       	call   801045a0 <release>
}
...
80102ad3:	e8 68 1c 00 00       	call   80104740 <memcmp>
...
80102c04:	e8 87 1b 00 00       	call   80104790 <memmove>
...
80102cb4:	e8 57 17 00 00       	call   80104410 <initlock>
  readsb(dev, &sb);
80102cb9:	58                   	pop    %eax
...
80102d4b:	e8 b0 18 00 00       	call   80104600 <acquire>
...
80102d65:	e8 16 13 00 00       	call   80104080 <sleep>
...
80102d9c:	e8 ff 17 00 00       	call   801045a0 <release>
      break;
    }
  }
}
...
80102dbe:	e8 3d 18 00 00       	call   80104600 <acquire>
  log.outstanding -= 1;
...
80102dfc:	e8 9f 17 00 00       	call   801045a0 <release>
}
...
80102e94:	e8 f7 18 00 00       	call   80104790 <memmove>
...
80102ef4:	e8 a7 16 00 00       	call   801045a0 <release>
...
80102f52:	e8 a9 16 00 00       	call   80104600 <acquire>
  for (i = 0; i < log.lh.n; i++) {
...
80102f98:	c9                   	leave
  release(&log.lock);
80102f99:	e9 02 16 00 00       	jmp    801045a0 <release>
...
801030a4:	e8 e7 16 00 00       	call   80104790 <memmove>
...
80103194:	e8 a7 15 00 00       	call   80104740 <memcmp>
...
80103249:	68 54 74 10 80       	push   $0x80107454
8010324e:	50                   	push   %eax
8010324f:	e8 ec 14 00 00       	call   80104740 <memcmp>
...
8010337b:	68 59 74 10 80       	push   $0x80107459
...
801033a2:	68 4f 74 10 80       	push   $0x8010744f
801033a7:	53                   	push   %ebx
801033a8:	e8 93 13 00 00       	call   80104740 <memcmp>
...
80103480:	00 00 00 
  initlock(&p->lock, "pipe");
80103483:	68 71 74 10 80       	push   $0x80107471
80103488:	50                   	push   %eax
80103489:	e8 82 0f 00 00       	call   80104410 <initlock>
  (*f0)->type = FD_PIPE;
...
8010350f:	e8 ec 10 00 00       	call   80104600 <acquire>
  if(writable){
...
8010352f:	e8 0c 0c 00 00       	call   80104140 <wakeup>
...
80103553:	5d                   	pop    %ebp
    release(&p->lock);
80103554:	e9 47 10 00 00       	jmp    801045a0 <release>
80103559:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    release(&p->lock);
80103560:	83 ec 0c             	sub    $0xc,%esp
80103563:	53                   	push   %ebx
80103564:	e8 37 10 00 00       	call   801045a0 <release>
    kfree((char*)p);
...
80103594:	e8 a7 0b 00 00       	call   80104140 <wakeup>
...
801035b0:	e8 4b 10 00 00       	call   80104600 <acquire>
  for(i = 0; i < n; i++){
...
80103610:	e8 2b 0b 00 00       	call   80104140 <wakeup>
      sleep(&p->nwrite, &p->lock);  //DOC: pipewrite-sleep
80103615:	58                   	pop    %eax
80103616:	5a                   	pop    %edx
80103617:	53                   	push   %ebx
80103618:	57                   	push   %edi
80103619:	e8 62 0a 00 00       	call   80104080 <sleep>
    while(p->nwrite == p->nread + PIPESIZE){  //DOC: pipewrite-full
...
80103644:	e8 57 0f 00 00       	call   801045a0 <release>
        return -1;
...
80103698:	e8 a3 0a 00 00       	call   80104140 <wakeup>
  release(&p->lock);
8010369d:	89 1c 24             	mov    %ebx,(%esp)
801036a0:	e8 fb 0e 00 00       	call   801045a0 <release>
  return n;
...
801036d6:	e8 25 0f 00 00       	call   80104600 <acquire>
...
80103705:	e8 76 09 00 00       	call   80104080 <sleep>
  while(p->nread == p->nwrite && p->writeopen){  //DOC: pipe-empty
...
8010376e:	e8 2d 0e 00 00       	call   801045a0 <release>
  return i;
...
80103789:	e8 12 0e 00 00       	call   801045a0 <release>
      return -1;
...
801037de:	c7 43 0c 01 00 00 00 	movl   $0x1,0xc(%ebx)
  p->tickets=1;
801037e5:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
  p->pid = nextpid++;
...
801037f7:	89 15 04 a0 10 80    	mov    %edx,0x8010a004
  release(&ptable.lock);
801037fd:	e8 9e 0d 00 00       	call   801045a0 <release>
...
8010381f:	89 53 1c             	mov    %edx,0x1c(%ebx)
  *(uint*)sp = (uint)trapret;
80103822:	c7 40 14 0f 59 10 80 	movl   $0x8010590f,0x14(%eax)
  p->context = (struct context*)sp;
...
80103831:	e8 ca 0e 00 00       	call   80104700 <memset>
...
8010385a:	e8 41 0d 00 00       	call   801045a0 <release>
  return 0;
...
8010388b:	e8 10 0d 00 00       	call   801045a0 <release>
...
80103974:	83 ec 04             	sub    $0x4,%esp
  pushcli();
80103977:	e8 34 0b 00 00       	call   801044b0 <pushcli>
  c = mycpu();
8010397c:	e8 6f ff ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103981:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103987:	e8 74 0b 00 00       	call   80104500 <popcli>
}
...
801039e6:	e8 15 0d 00 00       	call   80104700 <memset>
...
80103a45:	e8 66 0e 00 00       	call   801048b0 <safestrcpy>
  p->cwd = namei("/");
...
80103a95:	8b 75 08             	mov    0x8(%ebp),%esi
  pushcli();
80103a98:	e8 13 0a 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103a9d:	e8 4e fe ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103aa2:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103aa8:	e8 53 0a 00 00       	call   80104500 <popcli>
  sz = curproc->sz;
...
80103b16:	83 ec 1c             	sub    $0x1c,%esp
  pushcli();
80103b19:	e8 92 09 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103b1e:	e8 cd fd ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103b23:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103b29:	e8 d2 09 00 00       	call   80104500 <popcli>
  if((np = allocproc()) == 0){
...
80103c38:	89 c3                	mov    %eax,%ebx
  c->proc = 0;
80103c3a:	8d 70 04             	lea    0x4(%eax),%esi
...
80103c49:	e8 b2 09 00 00       	call   80104600 <acquire>
80103c4e:	83 c4 10             	add    $0x10,%esp
    int total = 0;
80103c51:	31 c9                	xor    %ecx,%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c53:	b8 54 1d 11 80       	mov    $0x80111d54,%eax
80103c58:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80103c5f:	00 
      if(p->state == RUNNABLE)
80103c60:	83 78 0c 03          	cmpl   $0x3,0xc(%eax)
80103c64:	75 03                	jne    80103c69 <scheduler+0x49>
        total += p->tickets;
80103c66:	03 48 14             	add    0x14(%eax),%ecx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c69:	83 e8 80             	sub    $0xffffff80,%eax
80103c6c:	3d 54 3d 11 80       	cmp    $0x80113d54,%eax
80103c71:	75 ed                	jne    80103c60 <scheduler+0x40>
    if(total == 0){
80103c73:	85 c9                	test   %ecx,%ecx
80103c75:	75 12                	jne    80103c89 <scheduler+0x69>
      release(&ptable.lock);
80103c77:	83 ec 0c             	sub    $0xc,%esp
80103c7a:	68 20 1d 11 80       	push   $0x80111d20
80103c7f:	e8 1c 09 00 00       	call   801045a0 <release>
      continue;
80103c84:	83 c4 10             	add    $0x10,%esp
80103c87:	eb b7                	jmp    80103c40 <scheduler+0x20>
  rand_state = rand_state * 1664525 + 1013904223;
80103c89:	69 05 08 a0 10 80 0d 	imul   $0x19660d,0x8010a008,%eax
80103c90:	66 19 00 
    int winner = rand() % total;
80103c93:	31 d2                	xor    %edx,%edx
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103c95:	bf 54 1d 11 80       	mov    $0x80111d54,%edi
  rand_state = rand_state * 1664525 + 1013904223;
80103c9a:	05 5f f3 6e 3c       	add    $0x3c6ef35f,%eax
80103c9f:	a3 08 a0 10 80       	mov    %eax,0x8010a008
    int winner = rand() % total;
80103ca4:	f7 f1                	div    %ecx
    int running_sum = 0;
80103ca6:	31 c0                	xor    %eax,%eax
80103ca8:	eb 11                	jmp    80103cbb <scheduler+0x9b>
80103caa:	8d b6 00 00 00 00    	lea    0x0(%esi),%esi
    for(p = ptable.proc; p < &ptable.proc[NPROC]; p++){
80103cb0:	83 ef 80             	sub    $0xffffff80,%edi
80103cb3:	81 ff 54 3d 11 80    	cmp    $0x80113d54,%edi
80103cb9:	74 bc                	je     80103c77 <scheduler+0x57>
      if(p->state != RUNNABLE)
80103cbb:	83 7f 0c 03          	cmpl   $0x3,0xc(%edi)
80103cbf:	75 ef                	jne    80103cb0 <scheduler+0x90>
      running_sum += p->tickets;
80103cc1:	03 47 14             	add    0x14(%edi),%eax
      if(running_sum > winner){
80103cc4:	39 c2                	cmp    %eax,%edx
80103cc6:	7d e8                	jge    80103cb0 <scheduler+0x90>
      switchuvm(chosen);
80103cc8:	83 ec 0c             	sub    $0xc,%esp
      c->proc = chosen;
80103ccb:	89 bb ac 00 00 00    	mov    %edi,0xac(%ebx)
      switchuvm(chosen);
80103cd1:	57                   	push   %edi
80103cd2:	e8 d9 2d 00 00       	call   80106ab0 <switchuvm>
      swtch(&(c->scheduler), chosen->context);
80103cd7:	58                   	pop    %eax
80103cd8:	5a                   	pop    %edx
80103cd9:	ff 77 20             	push   0x20(%edi)
80103cdc:	56                   	push   %esi
      chosen->state = RUNNING;
80103cdd:	c7 47 0c 04 00 00 00 	movl   $0x4,0xc(%edi)
      swtch(&(c->scheduler), chosen->context);
80103ce4:	e8 22 0c 00 00       	call   8010490b <swtch>
      switchkvm();
80103ce9:	e8 b2 2d 00 00       	call   80106aa0 <switchkvm>
      c->proc = 0;
80103cee:	83 c4 10             	add    $0x10,%esp
80103cf1:	c7 83 ac 00 00 00 00 	movl   $0x0,0xac(%ebx)
80103cf8:	00 00 00 
80103cfb:	e9 77 ff ff ff       	jmp    80103c77 <scheduler+0x57>
...
80103d4e:	83 c3 20             	add    $0x20,%ebx
  intena = mycpu()->intena;
...
80103ddc:	8d 70 2c             	lea    0x2c(%eax),%esi
80103ddf:	8d 78 6c             	lea    0x6c(%eax),%edi
...
80103e0f:	ff 73 6c             	push   0x6c(%ebx)
80103e12:	e8 b9 da ff ff       	call   801018d0 <iput>
  end_op();
80103e17:	e8 94 ef ff ff       	call   80102db0 <end_op>
  curproc->cwd = 0;
80103e1c:	c7 43 6c 00 00 00 00 	movl   $0x0,0x6c(%ebx)
  acquire(&ptable.lock);
80103e23:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103e2a:	e8 d1 07 00 00       	call   80104600 <acquire>
  wakeup1(curproc->parent);
80103e2f:	8b 53 18             	mov    0x18(%ebx),%edx
...
80103e81:	74 3b                	je     80103ebe <exit+0xfe>
    if(p->parent == curproc){
80103e83:	39 5a 18             	cmp    %ebx,0x18(%edx)
...
80103ecd:	68 fe 74 10 80       	push   $0x801074fe
80103ed2:	e8 a9 c4 ff ff       	call   80100380 <panic>
    panic("init exiting");
80103ed7:	83 ec 0c             	sub    $0xc,%esp
80103eda:	68 f1 74 10 80       	push   $0x801074f1
...
80103f31:	74 1b                	je     80103f4e <wait+0x5e>
      if(p->parent != curproc)
80103f33:	39 73 18             	cmp    %esi,0x18(%ebx)
...
80103f50:	0f 84 a7 00 00 00    	je     80103ffd <wait+0x10d>
80103f56:	8b 46 28             	mov    0x28(%esi),%eax
80103f59:	85 c0                	test   %eax,%eax
80103f5b:	0f 85 9c 00 00 00    	jne    80103ffd <wait+0x10d>
  pushcli();
80103f61:	e8 4a 05 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80103f66:	e8 85 f9 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80103f6b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80103f71:	e8 8a 05 00 00       	call   80104500 <popcli>
  if(p == 0)
80103f76:	85 db                	test   %ebx,%ebx
80103f78:	0f 84 96 00 00 00    	je     80104014 <wait+0x124>
  p->chan = chan;
80103f7e:	89 73 24             	mov    %esi,0x24(%ebx)
  p->state = SLEEPING;
80103f81:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
80103f88:	e8 73 fd ff ff       	call   80103d00 <sched>
  p->chan = 0;
80103f8d:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
}
...
80103fb9:	e8 a2 2e 00 00       	call   80106e60 <freevm>
        p->pid = 0;
80103fbe:	c7 43 10 00 00 00 00 	movl   $0x0,0x10(%ebx)
        p->parent = 0;
80103fc5:	c7 43 18 00 00 00 00 	movl   $0x0,0x18(%ebx)
        p->name[0] = 0;
80103fcc:	c6 43 70 00          	movb   $0x0,0x70(%ebx)
        p->killed = 0;
80103fd0:	c7 43 28 00 00 00 00 	movl   $0x0,0x28(%ebx)
        p->tickets = 1;
80103fd7:	c7 43 14 01 00 00 00 	movl   $0x1,0x14(%ebx)
        p->state = UNUSED;
80103fde:	c7 43 0c 00 00 00 00 	movl   $0x0,0xc(%ebx)
        release(&ptable.lock);
80103fe5:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
80103fec:	e8 af 05 00 00       	call   801045a0 <release>
        return pid;
...
80103ffd:	83 ec 0c             	sub    $0xc,%esp
      return -1;
80104000:	be ff ff ff ff       	mov    $0xffffffff,%esi
      release(&ptable.lock);
80104005:	68 20 1d 11 80       	push   $0x80111d20
8010400a:	e8 91 05 00 00       	call   801045a0 <release>
      return -1;
8010400f:	83 c4 10             	add    $0x10,%esp
80104012:	eb e0                	jmp    80103ff4 <wait+0x104>
    panic("sleep");
80104014:	83 ec 0c             	sub    $0xc,%esp
80104017:	68 0a 75 10 80       	push   $0x8010750a
8010401c:	e8 5f c3 ff ff       	call   80100380 <panic>
80104021:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104028:	00 
...
8010403c:	e8 bf 05 00 00       	call   80104600 <acquire>
  pushcli();
80104041:	e8 6a 04 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80104046:	e8 a5 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
8010404b:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
80104051:	e8 aa 04 00 00       	call   80104500 <popcli>
...
8010408c:	8b 75 0c             	mov    0xc(%ebp),%esi
  pushcli();
8010408f:	e8 1c 04 00 00       	call   801044b0 <pushcli>
  c = mycpu();
80104094:	e8 57 f8 ff ff       	call   801038f0 <mycpu>
  p = c->proc;
80104099:	8b 98 ac 00 00 00    	mov    0xac(%eax),%ebx
  popcli();
8010409f:	e8 5c 04 00 00       	call   80104500 <popcli>
  if(p == 0)
...
801040c0:	e8 3b 05 00 00       	call   80104600 <acquire>
    release(lk);
801040c5:	89 34 24             	mov    %esi,(%esp)
801040c8:	e8 d3 04 00 00       	call   801045a0 <release>
  p->chan = chan;
801040cd:	89 7b 24             	mov    %edi,0x24(%ebx)
  p->state = SLEEPING;
801040d0:	c7 43 0c 02 00 00 00 	movl   $0x2,0xc(%ebx)
  sched();
801040d7:	e8 24 fc ff ff       	call   80103d00 <sched>
  p->chan = 0;
801040dc:	c7 43 24 00 00 00 00 	movl   $0x0,0x24(%ebx)
    release(&ptable.lock);
801040e3:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801040ea:	e8 b1 04 00 00       	call   801045a0 <release>
    acquire(lk);
801040ef:	83 c4 10             	add    $0x10,%esp
801040f2:	89 75 08             	mov    %esi,0x8(%ebp)
}
...
801040fb:	5d                   	pop    %ebp
    acquire(lk);
801040fc:	e9 ff 04 00 00       	jmp    80104600 <acquire>
...
80104129:	68 10 75 10 80       	push   $0x80107510
8010412e:	e8 4d c2 ff ff       	call   80100380 <panic>
    panic("sleep");
80104133:	83 ec 0c             	sub    $0xc,%esp
80104136:	68 0a 75 10 80       	push   $0x8010750a
...
8010414f:	e8 ac 04 00 00       	call   80104600 <acquire>
...
80104170:	3b 58 24             	cmp    0x24(%eax),%ebx
...
80104190:	c9                   	leave
  release(&ptable.lock);
80104191:	e9 0a 04 00 00       	jmp    801045a0 <release>
...
801041af:	e8 4c 04 00 00       	call   80104600 <acquire>
...
801041cf:	83 78 0c 02          	cmpl   $0x2,0xc(%eax)
      p->killed = 1;
801041d3:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
      if(p->state == SLEEPING)
...
801041eb:	e8 b0 03 00 00       	call   801045a0 <release>
      return 0;
    }
  }
  release(&ptable.lock);
...
80104208:	e8 93 03 00 00       	call   801045a0 <release>
}
...
80104229:	bb c4 1d 11 80       	mov    $0x80111dc4,%ebx
...
801042a5:	e8 86 01 00 00       	call   80104430 <getcallerpcs>
      for(i=0; i<10 && pc[i] != 0; i++)
...
801042bd:	68 61 72 10 80       	push   $0x80107261
...
801042ea:	68 58 75 10 80       	push   $0x80107558
...
80104311:	c9                   	leave
80104312:	c3                   	ret
80104313:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010431a:	00 
8010431b:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
...
8010432f:	e8 cc 02 00 00       	call   80104600 <acquire>
  while (lk->locked) {
...
8010436c:	5d                   	pop    %ebp
  release(&lk->lk);
8010436d:	e9 2e 02 00 00       	jmp    801045a0 <release>
80104372:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104379:	00 
...
8010438f:	e8 6c 02 00 00       	call   80104600 <acquire>
  lk->locked = 0;
...
801043b4:	5d                   	pop    %ebp
  release(&lk->lk);
801043b5:	e9 e6 01 00 00       	jmp    801045a0 <release>
...
801043d2:	e8 29 02 00 00       	call   80104600 <acquire>
...
801043e4:	e8 b7 01 00 00       	call   801045a0 <release>
  return r;
}
...
80104545:	68 63 75 10 80       	push   $0x80107563
8010454a:	e8 31 be ff ff       	call   80100380 <panic>
    panic("popcli");
8010454f:	83 ec 0c             	sub    $0xc,%esp
80104552:	68 7a 75 10 80       	push   $0x8010757a
...
80104583:	e8 68 f3 ff ff       	call   801038f0 <mycpu>
...
801045bb:	68 81 75 10 80       	push   $0x80107581
...
80104618:	0f 85 b2 00 00 00    	jne    801046d0 <acquire+0xd0>
  popcli();
8010461e:	e8 dd fe ff ff       	call   80104500 <popcli>
  asm volatile("lock; xchgl %0, %1" :
80104623:	b9 01 00 00 00       	mov    $0x1,%ecx
...
80104649:	8b 4d 08             	mov    0x8(%ebp),%ecx
  for(i = 0; i < 10; i++){
8010464c:	31 d2                	xor    %edx,%edx
  lk->cpu = mycpu();
8010464e:	89 43 08             	mov    %eax,0x8(%ebx)
    if(ebp == 0 || ebp < (uint*)KERNBASE || ebp == (uint*)0xffffffff)
80104651:	8d 85 00 00 00 80    	lea    -0x80000000(%ebp),%eax
80104657:	3d fe ff ff 7f       	cmp    $0x7ffffffe,%eax
8010465c:	77 32                	ja     80104690 <acquire+0x90>
  ebp = (uint*)v - 2;
8010465e:	89 e8                	mov    %ebp,%eax
80104660:	eb 14                	jmp    80104676 <acquire+0x76>
...
80104674:	77 1a                	ja     80104690 <acquire+0x90>
    pcs[i] = ebp[1];     // saved %eip
80104676:	8b 58 04             	mov    0x4(%eax),%ebx
80104679:	89 5c 91 0c          	mov    %ebx,0xc(%ecx,%edx,4)
  for(i = 0; i < 10; i++){
8010467d:	83 c2 01             	add    $0x1,%edx
    ebp = (uint*)ebp[0]; // saved %ebp
80104680:	8b 00                	mov    (%eax),%eax
  for(i = 0; i < 10; i++){
80104682:	83 fa 0a             	cmp    $0xa,%edx
80104685:	75 e1                	jne    80104668 <acquire+0x68>
}
80104687:	8b 5d fc             	mov    -0x4(%ebp),%ebx
8010468a:	c9                   	leave
8010468b:	c3                   	ret
8010468c:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80104690:	8d 44 91 0c          	lea    0xc(%ecx,%edx,4),%eax
80104694:	83 c1 34             	add    $0x34,%ecx
80104697:	89 ca                	mov    %ecx,%edx
80104699:	29 c2                	sub    %eax,%edx
8010469b:	83 e2 04             	and    $0x4,%edx
8010469e:	74 10                	je     801046b0 <acquire+0xb0>
    pcs[i] = 0;
801046a0:	c7 00 00 00 00 00    	movl   $0x0,(%eax)
  for(; i < 10; i++)
801046a6:	83 c0 04             	add    $0x4,%eax
801046a9:	39 c1                	cmp    %eax,%ecx
801046ab:	74 da                	je     80104687 <acquire+0x87>
...
801046b6:	83 c0 08             	add    $0x8,%eax
    pcs[i] = 0;
801046b9:	c7 40 fc 00 00 00 00 	movl   $0x0,-0x4(%eax)
  for(; i < 10; i++)
801046c0:	39 c1                	cmp    %eax,%ecx
801046c2:	75 ec                	jne    801046b0 <acquire+0xb0>
801046c4:	eb c1                	jmp    80104687 <acquire+0x87>
801046c6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801046cd:	00 
801046ce:	66 90                	xchg   %ax,%ax
  r = lock->locked && lock->cpu == mycpu();
801046d0:	8b 5b 08             	mov    0x8(%ebx),%ebx
801046d3:	e8 18 f2 ff ff       	call   801038f0 <mycpu>
801046d8:	39 c3                	cmp    %eax,%ebx
801046da:	0f 85 3e ff ff ff    	jne    8010461e <acquire+0x1e>
  popcli();
801046e0:	e8 1b fe ff ff       	call   80104500 <popcli>
    panic("acquire");
801046e5:	83 ec 0c             	sub    $0xc,%esp
801046e8:	68 89 75 10 80       	push   $0x80107589
801046ed:	e8 8e bc ff ff       	call   80100380 <panic>
801046f2:	66 90                	xchg   %ax,%ax
801046f4:	66 90                	xchg   %ax,%ax
...
80104768:	74 16                	je     80104780 <memcmp+0x40>
    if(*s1 != *s2)
8010476a:	0f b6 08             	movzbl (%eax),%ecx
8010476d:	0f b6 1a             	movzbl (%edx),%ebx
...
80104797:	8b 45 10             	mov    0x10(%ebp),%eax
...
80104845:	c9                   	leave
80104846:	c3                   	ret
80104847:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010484e:	00 
8010484f:	90                   	nop
...
80104967:	8b 5d 08             	mov    0x8(%ebp),%ebx
  char *s, *ep;
  struct proc *curproc = myproc();
8010496a:	e8 01 f0 ff ff       	call   80103970 <myproc>
...
801049b5:	e8 b6 ef ff ff       	call   80103970 <myproc>
...
801049c3:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
801049c6:	e8 a5 ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a0e:	89 c6                	mov    %eax,%esi
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a10:	e8 5b ef ff ff       	call   80103970 <myproc>
...
80104a1e:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a21:	e8 4a ef ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104a74:	53                   	push   %ebx
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
80104a75:	e8 f6 ee ff ff       	call   80103970 <myproc>
80104a7a:	8b 55 08             	mov    0x8(%ebp),%edx
80104a7d:	8b 40 1c             	mov    0x1c(%eax),%eax
80104a80:	8b 40 44             	mov    0x44(%eax),%eax
80104a83:	8d 1c 90             	lea    (%eax,%edx,4),%ebx
  struct proc *curproc = myproc();
80104a86:	e8 e5 ee ff ff       	call   80103970 <myproc>
  return fetchint((myproc()->tf->esp) + 4 + 4*n, ip);
...
80104ab6:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104abd:	00 
...
80104adf:	5d                   	pop    %ebp
80104ae0:	c3                   	ret
80104ae1:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
80104ae8:	00 
...
80104af4:	83 ec 04             	sub    $0x4,%esp
  int num;
  struct proc *curproc = myproc();
80104af7:	e8 74 ee ff ff       	call   80103970 <myproc>
...
80104b0c:	8b 14 85 20 7b 10 80 	mov    -0x7fef84e0(,%eax,4),%edx
...
80104b30:	50                   	push   %eax
            curproc->pid, curproc->name, num);
80104b31:	8d 43 70             	lea    0x70(%ebx),%eax
    cprintf("%d %s: unknown sys call %d\n",
80104b34:	50                   	push   %eax
80104b35:	ff 73 10             	push   0x10(%ebx)
80104b38:	68 91 75 10 80       	push   $0x80107591
80104b3d:	e8 6e bb ff ff       	call   801006b0 <cprintf>
    curproc->tf->eax = -1;
80104b42:	8b 43 1c             	mov    0x1c(%ebx),%eax
...
80104b7a:	e8 21 d5 ff ff       	call   801020a0 <nameiparent>
...
80104b8c:	e8 0f cc ff ff       	call   801017a0 <ilock>
...
80104b98:	e8 53 d1 ff ff       	call   80101cf0 <dirlookup>
...
80104baa:	e8 81 ce ff ff       	call   80101a30 <iunlockput>
    ilock(ip);
80104baf:	89 34 24             	mov    %esi,(%esp)
80104bb2:	e8 e9 cb ff ff       	call   801017a0 <ilock>
...
80104bdc:	e8 4f ce ff ff       	call   80101a30 <iunlockput>
    return 0;
...
80104bfa:	e8 31 ca ff ff       	call   80101630 <ialloc>
...
80104c10:	e8 8b cb ff ff       	call   801017a0 <ilock>
  ip->major = major;
...
80104c31:	e8 ba ca ff ff       	call   801016f0 <iupdate>
...
80104c48:	e8 73 d3 ff ff       	call   80101fc0 <dirlink>
...
80104c58:	e8 d3 cd ff ff       	call   80101a30 <iunlockput>
  return ip;
...
80104c79:	e8 72 ca ff ff       	call   801016f0 <iupdate>
    if(dirlink(ip, ".", ip->inum) < 0 || dirlink(ip, "..", dp->inum) < 0)
80104c7e:	83 c4 0c             	add    $0xc,%esp
80104c81:	ff 76 04             	push   0x4(%esi)
80104c84:	68 c9 75 10 80       	push   $0x801075c9
80104c89:	56                   	push   %esi
80104c8a:	e8 31 d3 ff ff       	call   80101fc0 <dirlink>
...
80104c9c:	68 c8 75 10 80       	push   $0x801075c8
80104ca1:	56                   	push   %esi
80104ca2:	e8 19 d3 ff ff       	call   80101fc0 <dirlink>
...
80104d00:	e8 6b ec ff ff       	call   80103970 <myproc>
...
80104d48:	e8 73 c1 ff ff       	call   80100ec0 <filedup>
  return fd;
...
80104dc4:	e8 77 c2 ff ff       	call   80101040 <fileread>
...
80104dd1:	5d                   	pop    %ebp
80104dd2:	c3                   	ret
80104dd3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
    return -1;
...
80104e44:	e8 87 c2 ff ff       	call   801010d0 <filewrite>
...
80104e91:	74 25                	je     80104eb8 <sys_close+0x58>
  myproc()->ofile[fd] = 0;
80104e93:	e8 d8 ea ff ff       	call   80103970 <myproc>
  fileclose(f);
...
80104ea4:	e8 67 c0 ff ff       	call   80100f10 <fileclose>
  return 0;
...
80104ee0:	e8 8b ea ff ff       	call   80103970 <myproc>
...
80104f0b:	e8 e0 c0 ff ff       	call   80100ff0 <filestat>
...
80104f62:	0f 88 e2 00 00 00    	js     8010504a <sys_link+0x11a>
  begin_op();
80104f68:	e8 d3 dd ff ff       	call   80102d40 <begin_op>
  if((ip = namei(old)) == 0){
80104f6d:	83 ec 0c             	sub    $0xc,%esp
80104f70:	ff 75 d4             	push   -0x2c(%ebp)
80104f73:	e8 08 d1 ff ff       	call   80102080 <namei>
...
80104fa8:	e8 43 c7 ff ff       	call   801016f0 <iupdate>
  iunlock(ip);
80104fad:	89 1c 24             	mov    %ebx,(%esp)
80104fb0:	e8 cb c8 ff ff       	call   80101880 <iunlock>
  if((dp = nameiparent(new, name)) == 0)
80104fb5:	58                   	pop    %eax
80104fb6:	5a                   	pop    %edx
80104fb7:	57                   	push   %edi
80104fb8:	ff 75 d0             	push   -0x30(%ebp)
80104fbb:	e8 e0 d0 ff ff       	call   801020a0 <nameiparent>
...
80104fcd:	e8 ce c7 ff ff       	call   801017a0 <ilock>
...
80104fe3:	e8 d8 cf ff ff       	call   80101fc0 <dirlink>
...
80104ff3:	e8 38 ca ff ff       	call   80101a30 <iunlockput>
  iput(ip);
80104ff8:	89 1c 24             	mov    %ebx,(%esp)
80104ffb:	e8 d0 c8 ff ff       	call   801018d0 <iput>
  end_op();
80105000:	e8 ab dd ff ff       	call   80102db0 <end_op>
  return 0;
...
8010501c:	e8 0f ca ff ff       	call   80101a30 <iunlockput>
    goto bad;
80105021:	83 c4 10             	add    $0x10,%esp
  ilock(ip);
80105024:	83 ec 0c             	sub    $0xc,%esp
80105027:	53                   	push   %ebx
80105028:	e8 73 c7 ff ff       	call   801017a0 <ilock>
  ip->nlink--;
8010502d:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
80105032:	89 1c 24             	mov    %ebx,(%esp)
80105035:	e8 b6 c6 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
8010503a:	89 1c 24             	mov    %ebx,(%esp)
8010503d:	e8 ee c9 ff ff       	call   80101a30 <iunlockput>
  end_op();
...
80105055:	e8 d6 c9 ff ff       	call   80101a30 <iunlockput>
    end_op();
8010505a:	e8 51 dd ff ff       	call   80102db0 <end_op>
    return -1;
8010505f:	83 c4 10             	add    $0x10,%esp
80105062:	eb e6                	jmp    8010504a <sys_link+0x11a>
    end_op();
80105064:	e8 47 dd ff ff       	call   80102db0 <end_op>
    return -1;
...
801050bd:	58                   	pop    %eax
801050be:	5a                   	pop    %edx
801050bf:	68 c9 75 10 80       	push   $0x801075c9
...
801050d8:	68 c8 75 10 80       	push   $0x801075c8
...
8010510d:	e8 8e c6 ff ff       	call   801017a0 <ilock>
  if(ip->nlink < 1)
...
80105140:	e8 6b ca ff ff       	call   80101bb0 <writei>
...
80105162:	e8 c9 c8 ff ff       	call   80101a30 <iunlockput>
  ip->nlink--;
80105167:	66 83 6b 56 01       	subw   $0x1,0x56(%ebx)
  iupdate(ip);
8010516c:	89 1c 24             	mov    %ebx,(%esp)
8010516f:	e8 7c c5 ff ff       	call   801016f0 <iupdate>
  iunlockput(ip);
80105174:	89 1c 24             	mov    %ebx,(%esp)
80105177:	e8 b4 c8 ff ff       	call   80101a30 <iunlockput>
  end_op();
8010517c:	e8 2f dc ff ff       	call   80102db0 <end_op>
  return 0;
...
801051ad:	e8 fe c8 ff ff       	call   80101ab0 <readi>
...
801051d6:	e8 55 c8 ff ff       	call   80101a30 <iunlockput>
  end_op();
801051db:	e8 d0 db ff ff       	call   80102db0 <end_op>
  return -1;
...
80105272:	78 79                	js     801052ed <sys_open+0xad>
  ...
  begin_op();
80105274:	e8 c7 da ff ff       	call   80102d40 <begin_op>
...
80105285:	e8 f6 cd ff ff       	call   80102080 <namei>
...
8010529b:	e8 00 c5 ff ff       	call   801017a0 <ilock>
...
801052ae:	e8 9d bb ff ff       	call   80100e50 <filealloc>
...
801052be:	31 db                	xor    %ebx,%ebx
    if(curproc->ofile[fd] == 0){
801052c0:	8b 54 98 2c          	mov    0x2c(%eax,%ebx,4),%edx
...
801052d4:	e8 37 bc ff ff       	call   80100f10 <fileclose>
801052d9:	83 c4 10             	add    $0x10,%esp
    iunlockput(ip);
801052dc:	83 ec 0c             	sub    $0xc,%esp
801052df:	56                   	push   %esi
801052e0:	e8 4b c7 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
80105320:	83 ec 0c             	sub    $0xc,%esp
      curproc->ofile[fd] = f;
80105323:	89 7c 98 2c          	mov    %edi,0x2c(%eax,%ebx,4)
  iunlock(ip);
80105327:	56                   	push   %esi
80105328:	e8 53 c5 ff ff       	call   80101880 <iunlock>
  end_op();
8010532d:	e8 7e da ff ff       	call   80102db0 <end_op>
...
80105378:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010537f:	00 
...
801053bf:	e8 6c c6 ff ff       	call   80101a30 <iunlockput>
  end_op();
...
801053cf:	c3                   	ret
    end_op();
801053d0:	e8 db d9 ff ff       	call   80102db0 <end_op>
    return -1;
...
801053e3:	83 ec 18             	sub    $0x18,%esp
  ...
  begin_op();
801053e6:	e8 55 d9 ff ff       	call   80102d40 <begin_op>
  if((argstr(0, &path)) < 0 ||
...
8010544e:	e8 dd c5 ff ff       	call   80101a30 <iunlockput>
  end_op();
80105453:	e8 58 d9 ff ff       	call   80102db0 <end_op>
  return 0;
...
8010547d:	89 c6                	mov    %eax,%esi
  ...
  begin_op();
8010547f:	e8 bc d8 ff ff       	call   80102d40 <begin_op>
...
8010549f:	e8 dc cb ff ff       	call   80102080 <namei>
...
801054b1:	e8 ea c2 ff ff       	call   801017a0 <ilock>
  if(ip->type != T_DIR){
...
801054c4:	e8 b7 c3 ff ff       	call   80101880 <iunlock>
  iput(curproc->cwd);
801054c9:	58                   	pop    %eax
801054ca:	ff 76 6c             	push   0x6c(%esi)
801054cd:	e8 fe c3 ff ff       	call   801018d0 <iput>
  end_op();
801054d2:	e8 d9 d8 ff ff       	call   80102db0 <end_op>
  curproc->cwd = ip;
...
801054f4:	e8 37 c5 ff ff       	call   80101a30 <iunlockput>
    end_op();
...
80105508:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010550f:	00 
    end_op();
80105510:	e8 9b d8 ff ff       	call   80102db0 <end_op>
    return -1;
80105515:	eb ea                	jmp    80105501 <sys_chdir+0x91>
80105517:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010551e:	00 
8010551f:	90                   	nop
...
80105603:	5d                   	pop    %ebp
80105604:	c3                   	ret
80105605:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
8010560c:	00 
...
8010563c:	e8 cf dd ff ff       	call   80103410 <pipealloc>
...
8010564b:	31 db                	xor    %ebx,%ebx
  struct proc *curproc = myproc();
8010564d:	e8 1e e3 ff ff       	call   80103970 <myproc>
    if(curproc->ofile[fd] == 0){
80105652:	8b 74 98 2c          	mov    0x2c(%eax,%ebx,4),%esi
...
80105681:	8d b4 26 00 00 00 00 	lea    0x0(%esi,%eiz,1),%esi
    if(curproc->ofile[fd] == 0){
80105688:	8b 4c 90 2c          	mov    0x2c(%eax,%edx,4),%ecx
...
8010569d:	c7 44 b0 0c 00 00 00 	movl   $0x0,0xc(%eax,%esi,4)
801056a4:	00 
    fileclose(rf);
801056a5:	83 ec 0c             	sub    $0xc,%esp
801056a8:	ff 75 e0             	push   -0x20(%ebp)
801056ab:	e8 60 b8 ff ff       	call   80100f10 <fileclose>
    fileclose(wf);
801056b0:	58                   	pop    %eax
801056b1:	ff 75 e4             	push   -0x1c(%ebp)
801056b4:	e8 57 b8 ff ff       	call   80100f10 <fileclose>
    return -1;
...
801056c3:	2e 8d 74 26 00       	lea    %cs:0x0(%esi,%eiz,1),%esi
      curproc->ofile[fd] = f;
801056c8:	89 7c 90 2c          	mov    %edi,0x2c(%eax,%edx,4)
  }
  fd[0] = fd0;
...
{
  return fork();
801056f0:	e9 1b e4 ff ff       	jmp    80103b10 <fork>
801056f5:	2e 8d b4 26 00 00 00 	lea    %cs:0x0(%esi,%eiz,1),%esi
801056fc:	00 
...
8010573e:	e8 5d ea ff ff       	call   801041a0 <kill>
...
80105763:	83 ec 08             	sub    $0x8,%esp
  return myproc()->pid;
80105766:	e8 05 e2 ff ff       	call   80103970 <myproc>
...
80105787:	78 27                	js     801057b0 <sys_sbrk+0x40>
    return -1;
  addr = myproc()->sz;
80105789:	e8 e2 e1 ff ff       	call   80103970 <myproc>
  if(growproc(n) < 0)
...
80105796:	e8 f5 e2 ff ff       	call   80103a90 <growproc>
...
801057dc:	68 80 3d 11 80       	push   $0x80113d80
801057e1:	e8 1a ee ff ff       	call   80104600 <acquire>
  ticks0 = ticks;
  while(ticks - ticks0 < n){
801057e6:	8b 55 f4             	mov    -0xc(%ebp),%edx
  ticks0 = ticks;
801057e9:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  while(ticks - ticks0 < n){
...
80105803:	68 80 3d 11 80       	push   $0x80113d80
80105808:	68 60 3d 11 80       	push   $0x80113d60
8010580d:	e8 6e e8 ff ff       	call   80104080 <sleep>
  while(ticks - ticks0 < n){
80105812:	a1 60 3d 11 80       	mov    0x80113d60,%eax
...
80105874:	83 ec 10             	sub    $0x10,%esp
  ...
  acquire(&tickslock);
80105877:	68 80 3d 11 80       	push   $0x80113d80
8010587c:	e8 7f ed ff ff       	call   80104600 <acquire>
  xticks = ticks;
80105881:	8b 1d 60 3d 11 80    	mov    0x80113d60,%ebx
  release(&tickslock);
80105887:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
...
801058b6:	78 38                	js     801058f0 <sys_settickets+0x50>
    return -1;

  if(n < 1)
801058b8:	8b 45 f4             	mov    -0xc(%ebp),%eax
801058bb:	85 c0                	test   %eax,%eax
801058bd:	7e 31                	jle    801058f0 <sys_settickets+0x50>
    return -1;

  acquire(&ptable.lock);
801058bf:	83 ec 0c             	sub    $0xc,%esp
801058c2:	68 20 1d 11 80       	push   $0x80111d20
801058c7:	e8 34 ed ff ff       	call   80104600 <acquire>
  myproc()->tickets = n;
801058cc:	e8 9f e0 ff ff       	call   80103970 <myproc>
801058d1:	8b 55 f4             	mov    -0xc(%ebp),%edx
801058d4:	89 50 14             	mov    %edx,0x14(%eax)
  release(&ptable.lock);
801058d7:	c7 04 24 20 1d 11 80 	movl   $0x80111d20,(%esp)
801058de:	e8 bd ec ff ff       	call   801045a0 <release>
...
80105906:	54                   	push   %esp
  call trap
80105907:	e8 c4 00 00 00       	call   801059d0 <trap>
  addl $4, %esp
...
80105930:	8b 14 85 0c a0 10 80 	mov    -0x7fef5ff4(,%eax,4),%edx
80105937:	c7 04 c5 c2 3d 11 80 	movl   $0x8e000008,-0x7feec23e(,%eax,8)
8010593e:	08 00 00 8e 
80105942:	66 89 14 c5 c0 3d 11 	mov    %dx,-0x7feec240(,%eax,8)
80105949:	80 
8010594a:	c1 ea 10             	shr    $0x10,%edx
8010594d:	66 89 14 c5 c6 3d 11 	mov    %dx,-0x7feec23a(,%eax,8)
80105954:	80 
  for(i = 0; i < 256; i++)
...
8010595f:	83 ec 08             	sub    $0x8,%esp
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
80105962:	a1 0c a1 10 80       	mov    0x8010a10c,%eax
80105967:	c7 05 c2 3f 11 80 08 	movl   $0xef000008,0x80113fc2
8010596e:	00 00 ef 
  initlock(&tickslock, "time");
80105971:	68 0e 76 10 80       	push   $0x8010760e
80105976:	68 80 3d 11 80       	push   $0x80113d80
  SETGATE(idt[T_SYSCALL], 1, SEG_KCODE<<3, vectors[T_SYSCALL], DPL_USER);
8010597b:	66 a3 c0 3f 11 80    	mov    %ax,0x80113fc0
80105981:	c1 e8 10             	shr    $0x10,%eax
80105984:	66 a3 c6 3f 11 80    	mov    %ax,0x80113fc6
  initlock(&tickslock, "time");
...
801059ab:	66 89 45 fa          	mov    %ax,-0x6(%ebp)
  pd[1] = (uint)p;
801059af:	b8 c0 3d 11 80       	mov    $0x80113dc0,%eax
...
801059f4:	ff 24 85 80 7b 10 80 	jmp    *-0x7fef8480(,%eax,4)
...
80105a18:	8b 50 28             	mov    0x28(%eax),%edx
...
80105a53:	8b 40 28             	mov    0x28(%eax),%eax
...
80105abe:	83 c6 70             	add    $0x70,%esi
    cprintf("pid %d %s: trap %d err %d on cpu %d "
...
80105ad7:	c7 40 28 01 00 00 00 	movl   $0x1,0x28(%eax)
  if(myproc() && myproc()->killed && (tf->cs&3) == DPL_USER)
...
80105af4:	0f 85 4b ff ff ff    	jne    80105a45 <trap+0x75>
    yield();
80105afa:	e8 31 e5 ff ff       	call   80104030 <yield>
...
80105b45:	8b 70 28             	mov    0x28(%eax),%esi
...
80105b55:	89 58 1c             	mov    %ebx,0x1c(%eax)
    syscall();
80105b58:	e8 93 ef ff ff       	call   80104af0 <syscall>
    if(myproc()->killed)
80105b5d:	e8 0e de ff ff       	call   80103970 <myproc>
80105b62:	8b 48 28             	mov    0x28(%eax),%ecx
...
80105bd0:	68 80 3d 11 80       	push   $0x80113d80
80105bd5:	e8 26 ea ff ff       	call   80104600 <acquire>
      ticks++;
80105bda:	83 05 60 3d 11 80 01 	addl   $0x1,0x80113d60
      wakeup(&ticks);
80105be1:	c7 04 24 60 3d 11 80 	movl   $0x80113d60,(%esp)
80105be8:	e8 53 e5 ff ff       	call   80104140 <wakeup>
      release(&tickslock);
80105bed:	c7 04 24 80 3d 11 80 	movl   $0x80113d80,(%esp)
80105bf4:	e8 a7 e9 ff ff       	call   801045a0 <release>
...
{
  if(!uart)
80105c50:	a1 c0 45 11 80       	mov    0x801145c0,%eax
...
80105cd7:	0f 84 7c 00 00 00    	je     80105d59 <uartinit+0xd9>
  uart = 1;
80105cdd:	c7 05 c0 45 11 80 01 	movl   $0x1,0x801145c0
80105ce4:	00 00 00 
...
80105de7:	6a 00                	push   $0x0
  jmp alltraps
80105de9:	e9 09 fb ff ff       	jmp    801058f7 <alltraps>
...
80105df0:	6a 01                	push   $0x1
  jmp alltraps
80105df2:	e9 00 fb ff ff       	jmp    801058f7 <alltraps>
...
80105df9:	6a 02                	push   $0x2
  jmp alltraps
80105dfb:	e9 f7 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e02:	6a 03                	push   $0x3
  jmp alltraps
80105e04:	e9 ee fa ff ff       	jmp    801058f7 <alltraps>
...
80105e0b:	6a 04                	push   $0x4
  jmp alltraps
80105e0d:	e9 e5 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e14:	6a 05                	push   $0x5
  jmp alltraps
80105e16:	e9 dc fa ff ff       	jmp    801058f7 <alltraps>
...
80105e1d:	6a 06                	push   $0x6
  jmp alltraps
80105e1f:	e9 d3 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e26:	6a 07                	push   $0x7
  jmp alltraps
80105e28:	e9 ca fa ff ff       	jmp    801058f7 <alltraps>
...
80105e2d:	6a 08                	push   $0x8
  jmp alltraps
80105e2f:	e9 c3 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e36:	6a 09                	push   $0x9
  jmp alltraps
80105e38:	e9 ba fa ff ff       	jmp    801058f7 <alltraps>
...
80105e3d:	6a 0a                	push   $0xa
  jmp alltraps
80105e3f:	e9 b3 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e44:	6a 0b                	push   $0xb
  jmp alltraps
80105e46:	e9 ac fa ff ff       	jmp    801058f7 <alltraps>
...
80105e4b:	6a 0c                	push   $0xc
  jmp alltraps
80105e4d:	e9 a5 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e52:	6a 0d                	push   $0xd
  jmp alltraps
80105e54:	e9 9e fa ff ff       	jmp    801058f7 <alltraps>
...
80105e59:	6a 0e                	push   $0xe
  jmp alltraps
80105e5b:	e9 97 fa ff ff       	jmp    801058f7 <alltraps>
...
80105e62:	6a 0f                	push   $0xf
  jmp alltraps
80105e64:	e9 8e fa ff ff       	jmp    801058f7 <alltraps>
...
80105e6b:	6a 10                	push   $0x10
  jmp alltraps
80105e6d:	e9 85 fa ff ff       	jmp    801058f7 <alltraps>
...
80106208:	6a 77                	push   $0x77
  jmp alltraps
8010620a:	e9 e8 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106211:	6a 78                	push   $0x78
  jmp alltraps
80106213:	e9 df f6 ff ff       	jmp    801058f7 <alltraps>
...
8010621a:	6a 79                	push   $0x79
  jmp alltraps
8010621c:	e9 d6 f6 ff ff       	jmp    801058f7 <alltraps>
...
8010622c:	6a 7b                	push   $0x7b
  jmp alltraps
8010622e:	e9 c4 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106235:	6a 7c                	push   $0x7c
  jmp alltraps
80106237:	e9 bb f6 ff ff       	jmp    801058f7 <alltraps>
...
8010623e:	6a 7d                	push   $0x7d
  jmp alltraps
80106240:	e9 b2 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106250:	6a 7f                	push   $0x7f
  jmp alltraps
80106252:	e9 a0 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106259:	68 80 00 00 00       	push   $0x80
  jmp alltraps
8010625e:	e9 94 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106265:	68 81 00 00 00       	push   $0x81
  jmp alltraps
8010626a:	e9 88 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106271:	68 82 00 00 00       	push   $0x82
  jmp alltraps
80106276:	e9 7c f6 ff ff       	jmp    801058f7 <alltraps>
...
8010627d:	68 83 00 00 00       	push   $0x83
  jmp alltraps
80106282:	e9 70 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106289:	68 84 00 00 00       	push   $0x84
  jmp alltraps
8010628e:	e9 64 f6 ff ff       	jmp    801058f7 <alltraps>
...
80106295:	68 85 00 00 00       	push   $0x85
  jmp alltraps
8010629a:	e9 58 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062a1:	68 86 00 00 00       	push   $0x86
  jmp alltraps
801062a6:	e9 4c f6 ff ff       	jmp    801058f7 <alltraps>
...
801062ad:	68 87 00 00 00       	push   $0x87
  jmp alltraps
801062b2:	e9 40 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062b9:	68 88 00 00 00       	push   $0x88
  jmp alltraps
801062be:	e9 34 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062c5:	68 89 00 00 00       	push   $0x89
  jmp alltraps
801062ca:	e9 28 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062d1:	68 8a 00 00 00       	push   $0x8a
  jmp alltraps
801062d6:	e9 1c f6 ff ff       	jmp    801058f7 <alltraps>
...
801062dd:	68 8b 00 00 00       	push   $0x8b
  jmp alltraps
801062e2:	e9 10 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062e9:	68 8c 00 00 00       	push   $0x8c
  jmp alltraps
801062ee:	e9 04 f6 ff ff       	jmp    801058f7 <alltraps>
...
801062f5:	68 8d 00 00 00       	push   $0x8d
  jmp alltraps
801062fa:	e9 f8 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106301:	68 8e 00 00 00       	push   $0x8e
  jmp alltraps
80106306:	e9 ec f5 ff ff       	jmp    801058f7 <alltraps>
...
8010630d:	68 8f 00 00 00       	push   $0x8f
  jmp alltraps
80106312:	e9 e0 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106319:	68 90 00 00 00       	push   $0x90
  jmp alltraps
8010631e:	e9 d4 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106325:	68 91 00 00 00       	push   $0x91
  jmp alltraps
8010632a:	e9 c8 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106331:	68 92 00 00 00       	push   $0x92
  jmp alltraps
80106336:	e9 bc f5 ff ff       	jmp    801058f7 <alltraps>
...
8010633d:	68 93 00 00 00       	push   $0x93
  jmp alltraps
80106342:	e9 b0 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106349:	68 94 00 00 00       	push   $0x94
  jmp alltraps
8010634e:	e9 a4 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106355:	68 95 00 00 00       	push   $0x95
  jmp alltraps
8010635a:	e9 98 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106361:	68 96 00 00 00       	push   $0x96
  jmp alltraps
80106366:	e9 8c f5 ff ff       	jmp    801058f7 <alltraps>
...
8010636d:	68 97 00 00 00       	push   $0x97
  jmp alltraps
80106372:	e9 80 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106379:	68 98 00 00 00       	push   $0x98
  jmp alltraps
8010637e:	e9 74 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106385:	68 99 00 00 00       	push   $0x99
  jmp alltraps
8010638a:	e9 68 f5 ff ff       	jmp    801058f7 <alltraps>
...
80106391:	68 9a 00 00 00       	push   $0x9a
  jmp alltraps
80106396:	e9 5c f5 ff ff       	jmp    801058f7 <alltraps>
...
8010639d:	68 9b 00 00 00       	push   $0x9b
  jmp alltraps
801063a2:	e9 50 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063a9:	68 9c 00 00 00       	push   $0x9c
  jmp alltraps
801063ae:	e9 44 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063b5:	68 9d 00 00 00       	push   $0x9d
  jmp alltraps
801063ba:	e9 38 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063c1:	68 9e 00 00 00       	push   $0x9e
  jmp alltraps
801063c6:	e9 2c f5 ff ff       	jmp    801058f7 <alltraps>
...
801063cd:	68 9f 00 00 00       	push   $0x9f
  jmp alltraps
801063d2:	e9 20 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063d9:	68 a0 00 00 00       	push   $0xa0
  jmp alltraps
801063de:	e9 14 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063e5:	68 a1 00 00 00       	push   $0xa1
  jmp alltraps
801063ea:	e9 08 f5 ff ff       	jmp    801058f7 <alltraps>
...
801063f1:	68 a2 00 00 00       	push   $0xa2
  jmp alltraps
801063f6:	e9 fc f4 ff ff       	jmp    801058f7 <alltraps>
...
801063fd:	68 a3 00 00 00       	push   $0xa3
  jmp alltraps
80106402:	e9 f0 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106409:	68 a4 00 00 00       	push   $0xa4
  jmp alltraps
8010640e:	e9 e4 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106415:	68 a5 00 00 00       	push   $0xa5
  jmp alltraps
8010641a:	e9 d8 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106421:	68 a6 00 00 00       	push   $0xa6
  jmp alltraps
80106426:	e9 cc f4 ff ff       	jmp    801058f7 <alltraps>
...
8010642d:	68 a7 00 00 00       	push   $0xa7
  jmp alltraps
80106432:	e9 c0 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106439:	68 a8 00 00 00       	push   $0xa8
  jmp alltraps
8010643e:	e9 b4 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106445:	68 a9 00 00 00       	push   $0xa9
  jmp alltraps
8010644a:	e9 a8 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106451:	68 aa 00 00 00       	push   $0xaa
  jmp alltraps
80106456:	e9 9c f4 ff ff       	jmp    801058f7 <alltraps>
...
8010645d:	68 ab 00 00 00       	push   $0xab
  jmp alltraps
80106462:	e9 90 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106469:	68 ac 00 00 00       	push   $0xac
  jmp alltraps
8010646e:	e9 84 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106475:	68 ad 00 00 00       	push   $0xad
  jmp alltraps
8010647a:	e9 78 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106481:	68 ae 00 00 00       	push   $0xae
  jmp alltraps
80106486:	e9 6c f4 ff ff       	jmp    801058f7 <alltraps>
...
8010648d:	68 af 00 00 00       	push   $0xaf
  jmp alltraps
80106492:	e9 60 f4 ff ff       	jmp    801058f7 <alltraps>
...
80106499:	68 b0 00 00 00       	push   $0xb0
  jmp alltraps
8010649e:	e9 54 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064a5:	68 b1 00 00 00       	push   $0xb1
  jmp alltraps
801064aa:	e9 48 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064b1:	68 b2 00 00 00       	push   $0xb2
  jmp alltraps
801064b6:	e9 3c f4 ff ff       	jmp    801058f7 <alltraps>
...
801064bd:	68 b3 00 00 00       	push   $0xb3
  jmp alltraps
801064c2:	e9 30 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064c9:	68 b4 00 00 00       	push   $0xb4
  jmp alltraps
801064ce:	e9 24 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064d5:	68 b5 00 00 00       	push   $0xb5
  jmp alltraps
801064da:	e9 18 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064e1:	68 b6 00 00 00       	push   $0xb6
  jmp alltraps
801064e6:	e9 0c f4 ff ff       	jmp    801058f7 <alltraps>
...
801064ed:	68 b7 00 00 00       	push   $0xb7
  jmp alltraps
801064f2:	e9 00 f4 ff ff       	jmp    801058f7 <alltraps>
...
801064f9:	68 b8 00 00 00       	push   $0xb8
  jmp alltraps
801064fe:	e9 f4 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106505:	68 b9 00 00 00       	push   $0xb9
  jmp alltraps
8010650a:	e9 e8 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106511:	68 ba 00 00 00       	push   $0xba
  jmp alltraps
80106516:	e9 dc f3 ff ff       	jmp    801058f7 <alltraps>
...
8010651d:	68 bb 00 00 00       	push   $0xbb
  jmp alltraps
80106522:	e9 d0 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106529:	68 bc 00 00 00       	push   $0xbc
  jmp alltraps
8010652e:	e9 c4 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106535:	68 bd 00 00 00       	push   $0xbd
  jmp alltraps
8010653a:	e9 b8 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106541:	68 be 00 00 00       	push   $0xbe
  jmp alltraps
80106546:	e9 ac f3 ff ff       	jmp    801058f7 <alltraps>
...
8010654d:	68 bf 00 00 00       	push   $0xbf
  jmp alltraps
80106552:	e9 a0 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106559:	68 c0 00 00 00       	push   $0xc0
  jmp alltraps
8010655e:	e9 94 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106565:	68 c1 00 00 00       	push   $0xc1
  jmp alltraps
8010656a:	e9 88 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106571:	68 c2 00 00 00       	push   $0xc2
  jmp alltraps
80106576:	e9 7c f3 ff ff       	jmp    801058f7 <alltraps>
...
8010657d:	68 c3 00 00 00       	push   $0xc3
  jmp alltraps
80106582:	e9 70 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106589:	68 c4 00 00 00       	push   $0xc4
  jmp alltraps
8010658e:	e9 64 f3 ff ff       	jmp    801058f7 <alltraps>
...
80106595:	68 c5 00 00 00       	push   $0xc5
  jmp alltraps
8010659a:	e9 58 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065a1:	68 c6 00 00 00       	push   $0xc6
  jmp alltraps
801065a6:	e9 4c f3 ff ff       	jmp    801058f7 <alltraps>
...
801065ad:	68 c7 00 00 00       	push   $0xc7
  jmp alltraps
801065b2:	e9 40 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065b9:	68 c8 00 00 00       	push   $0xc8
  jmp alltraps
801065be:	e9 34 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065c5:	68 c9 00 00 00       	push   $0xc9
  jmp alltraps
801065ca:	e9 28 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065d1:	68 ca 00 00 00       	push   $0xca
  jmp alltraps
801065d6:	e9 1c f3 ff ff       	jmp    801058f7 <alltraps>
...
801065dd:	68 cb 00 00 00       	push   $0xcb
  jmp alltraps
801065e2:	e9 10 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065e9:	68 cc 00 00 00       	push   $0xcc
  jmp alltraps
801065ee:	e9 04 f3 ff ff       	jmp    801058f7 <alltraps>
...
801065f5:	68 cd 00 00 00       	push   $0xcd
  jmp alltraps
801065fa:	e9 f8 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106601:	68 ce 00 00 00       	push   $0xce
  jmp alltraps
80106606:	e9 ec f2 ff ff       	jmp    801058f7 <alltraps>
...
8010660d:	68 cf 00 00 00       	push   $0xcf
  jmp alltraps
80106612:	e9 e0 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106619:	68 d0 00 00 00       	push   $0xd0
  jmp alltraps
8010661e:	e9 d4 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106625:	68 d1 00 00 00       	push   $0xd1
  jmp alltraps
8010662a:	e9 c8 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106631:	68 d2 00 00 00       	push   $0xd2
  jmp alltraps
80106636:	e9 bc f2 ff ff       	jmp    801058f7 <alltraps>
...
8010663d:	68 d3 00 00 00       	push   $0xd3
  jmp alltraps
80106642:	e9 b0 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106649:	68 d4 00 00 00       	push   $0xd4
  jmp alltraps
8010664e:	e9 a4 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106655:	68 d5 00 00 00       	push   $0xd5
  jmp alltraps
8010665a:	e9 98 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106661:	68 d6 00 00 00       	push   $0xd6
  jmp alltraps
80106666:	e9 8c f2 ff ff       	jmp    801058f7 <alltraps>
...
8010666d:	68 d7 00 00 00       	push   $0xd7
  jmp alltraps
80106672:	e9 80 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106679:	68 d8 00 00 00       	push   $0xd8
  jmp alltraps
8010667e:	e9 74 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106685:	68 d9 00 00 00       	push   $0xd9
  jmp alltraps
8010668a:	e9 68 f2 ff ff       	jmp    801058f7 <alltraps>
...
80106691:	68 da 00 00 00       	push   $0xda
  jmp alltraps
80106696:	e9 5c f2 ff ff       	jmp    801058f7 <alltraps>
...
8010669d:	68 db 00 00 00       	push   $0xdb
  jmp alltraps
801066a2:	e9 50 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066a9:	68 dc 00 00 00       	push   $0xdc
  jmp alltraps
801066ae:	e9 44 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066b5:	68 dd 00 00 00       	push   $0xdd
  jmp alltraps
801066ba:	e9 38 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066c1:	68 de 00 00 00       	push   $0xde
  jmp alltraps
801066c6:	e9 2c f2 ff ff       	jmp    801058f7 <alltraps>
...
801066cd:	68 df 00 00 00       	push   $0xdf
  jmp alltraps
801066d2:	e9 20 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066d9:	68 e0 00 00 00       	push   $0xe0
  jmp alltraps
801066de:	e9 14 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066e5:	68 e1 00 00 00       	push   $0xe1
  jmp alltraps
801066ea:	e9 08 f2 ff ff       	jmp    801058f7 <alltraps>
...
801066f1:	68 e2 00 00 00       	push   $0xe2
  jmp alltraps
801066f6:	e9 fc f1 ff ff       	jmp    801058f7 <alltraps>
...
801066fd:	68 e3 00 00 00       	push   $0xe3
  jmp alltraps
80106702:	e9 f0 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106709:	68 e4 00 00 00       	push   $0xe4
  jmp alltraps
8010670e:	e9 e4 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106715:	68 e5 00 00 00       	push   $0xe5
  jmp alltraps
8010671a:	e9 d8 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106721:	68 e6 00 00 00       	push   $0xe6
  jmp alltraps
80106726:	e9 cc f1 ff ff       	jmp    801058f7 <alltraps>
...
8010672d:	68 e7 00 00 00       	push   $0xe7
  jmp alltraps
80106732:	e9 c0 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106739:	68 e8 00 00 00       	push   $0xe8
  jmp alltraps
8010673e:	e9 b4 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106745:	68 e9 00 00 00       	push   $0xe9
  jmp alltraps
8010674a:	e9 a8 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106751:	68 ea 00 00 00       	push   $0xea
  jmp alltraps
80106756:	e9 9c f1 ff ff       	jmp    801058f7 <alltraps>
...
8010675d:	68 eb 00 00 00       	push   $0xeb
  jmp alltraps
80106762:	e9 90 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106769:	68 ec 00 00 00       	push   $0xec
  jmp alltraps
8010676e:	e9 84 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106775:	68 ed 00 00 00       	push   $0xed
  jmp alltraps
8010677a:	e9 78 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106781:	68 ee 00 00 00       	push   $0xee
  jmp alltraps
80106786:	e9 6c f1 ff ff       	jmp    801058f7 <alltraps>
...
8010678d:	68 ef 00 00 00       	push   $0xef
  jmp alltraps
80106792:	e9 60 f1 ff ff       	jmp    801058f7 <alltraps>
...
80106799:	68 f0 00 00 00       	push   $0xf0
  jmp alltraps
8010679e:	e9 54 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067a5:	68 f1 00 00 00       	push   $0xf1
  jmp alltraps
801067aa:	e9 48 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067b1:	68 f2 00 00 00       	push   $0xf2
  jmp alltraps
801067b6:	e9 3c f1 ff ff       	jmp    801058f7 <alltraps>
...
801067bd:	68 f3 00 00 00       	push   $0xf3
  jmp alltraps
801067c2:	e9 30 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067c9:	68 f4 00 00 00       	push   $0xf4
  jmp alltraps
801067ce:	e9 24 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067d5:	68 f5 00 00 00       	push   $0xf5
  jmp alltraps
801067da:	e9 18 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067e1:	68 f6 00 00 00       	push   $0xf6
  jmp alltraps
801067e6:	e9 0c f1 ff ff       	jmp    801058f7 <alltraps>
...
801067ed:	68 f7 00 00 00       	push   $0xf7
  jmp alltraps
801067f2:	e9 00 f1 ff ff       	jmp    801058f7 <alltraps>
...
801067f9:	68 f8 00 00 00       	push   $0xf8
  jmp alltraps
801067fe:	e9 f4 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106805:	68 f9 00 00 00       	push   $0xf9
  jmp alltraps
8010680a:	e9 e8 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106811:	68 fa 00 00 00       	push   $0xfa
  jmp alltraps
80106816:	e9 dc f0 ff ff       	jmp    801058f7 <alltraps>
...
8010681d:	68 fb 00 00 00       	push   $0xfb
  jmp alltraps
80106822:	e9 d0 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106829:	68 fc 00 00 00       	push   $0xfc
  jmp alltraps
8010682e:	e9 c4 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106835:	68 fd 00 00 00       	push   $0xfd
  jmp alltraps
8010683a:	e9 b8 f0 ff ff       	jmp    801058f7 <alltraps>
...
80106841:	68 fe 00 00 00       	push   $0xfe
  jmp alltraps
80106846:	e9 ac f0 ff ff       	jmp    801058f7 <alltraps>
...
8010684d:	68 ff 00 00 00       	push   $0xff
  jmp alltraps
80106852:	e9 a0 f0 ff ff       	jmp    801058f7 <alltraps>
...
801069b7:	e8 44 dd ff ff       	call   80104700 <memset>
...
80106aa0:	a1 c4 45 11 80       	mov    0x801145c4,%eax
...
80106ad4:	0f 84 c2 00 00 00    	je     80106b9c <switchuvm+0xec>
  pushcli();
80106ada:	e8 d1 d9 ff ff       	call   801044b0 <pushcli>
...
80106b89:	5d                   	pop    %ebp
  popcli();
80106b8a:	e9 71 d9 ff ff       	jmp    80104500 <popcli>
...
80106bef:	e8 0c db ff ff       	call   80104700 <memset>
...
80106c20:	5d                   	pop    %ebp
  memmove(mem, init, sz);
80106c21:	e9 6a db ff ff       	jmp    80104790 <memmove>
...
80106f00:	e8 fb d7 ff ff       	call   80104700 <memset>
...
80106f6b:	a3 c4 45 11 80       	mov    %eax,0x801145c4
  lcr3(V2P(kpgdir));   // switch to the kernel page table
...
80107070:	e8 1b d7 ff ff       	call   80104790 <memmove>
