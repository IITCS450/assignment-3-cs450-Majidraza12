...
_setticketstest:     file format elf32-i386
...
main(int argc, char *argv[])
{
  ...
  24:	e8 4a 03 00 00       	call   373 <settickets>
  if(r == 0)
  29:	83 c4 10             	add    $0x10,%esp
  2c:	85 c0                	test   %eax,%eax
  2e:	75 39                	jne    69 <main+0x69>
    printf(1, "Success: tickets set to 10\n");
  30:	50                   	push   %eax
  31:	50                   	push   %eax
  32:	68 69 07 00 00       	push   $0x769
  37:	6a 01                	push   $0x1
  ...
  7c:	52                   	push   %edx
  7d:	52                   	push   %edx
  7e:	68 48 07 00 00       	push   $0x748
  83:	6a 01                	push   $0x1
  85:	e8 96 03 00 00       	call   420 <printf>
  8a:	83 c4 10             	add    $0x10,%esp
  8d:	eb d5                	jmp    64 <main+0x64>
  8f:	90                   	nop
 ...
 388:	89 d1                	mov    %edx,%ecx
{
 ...
 3bb:	0f b6 92 20 08 00 00 	movzbl 0x820(%edx),%edx
 ...
 429:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 494:	ff 24 85 c8 07 00 00 	jmp    *0x7c8(,%eax,4)
 ...
 5a0:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 5a5:	bb c1 07 00 00       	mov    $0x7c1,%ebx
 ...
 5b1:	a1 bc 0a 00 00       	mov    0xabc,%eax
{
 ...
 5ef:	5b                   	pop    %ebx
  freep = p;
 5f0:	a3 bc 0a 00 00       	mov    %eax,0xabc
}
 5f5:	5e                   	pop    %esi
 5f6:	5f                   	pop    %edi
 5f7:	5d                   	pop    %ebp
 ...
 606:	72 ce                	jb     5d6 <free+0x26>
{
 ...
 627:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 62a:	a3 bc 0a 00 00       	mov    %eax,0xabc
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 649:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 64c:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 68b:	3b 05 bc 0a 00 00    	cmp    0xabc,%eax
 ...
 6ae:	e8 fd fe ff ff       	call   5b0 <free>
  return freep;
 6b3:	8b 15 bc 0a 00 00    	mov    0xabc,%edx
 ...
 6dc:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 6df:	89 15 bc 0a 00 00    	mov    %edx,0xabc
}
 ...
 6ef:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 6f0:	c7 05 bc 0a 00 00 c0 	movl   $0xac0,0xabc
 6f7:	0a 00 00 
    base.s.size = 0;
 6fa:	b8 c0 0a 00 00       	mov    $0xac0,%eax
    base.s.ptr = freep = prevp = &base;
 6ff:	c7 05 c0 0a 00 00 c0 	movl   $0xac0,0xac0
 706:	0a 00 00 
    base.s.size = 0;
 709:	c7 05 c4 0a 00 00 00 	movl   $0x0,0xac4
 710:	00 00 00 
    if(p->s.size >= nunits){
