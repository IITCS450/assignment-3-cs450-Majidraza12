...
int main(int argc, char **argv){
  ...
  if(settickets(0) == 0){
  23:	6a 00                	push   $0x0
  25:	e8 a9 03 00 00       	call   3d3 <settickets>
  2a:	83 c4 10             	add    $0x10,%esp
  2d:	85 c0                	test   %eax,%eax
  2f:	0f 84 81 00 00 00    	je     b6 <main+0xb6>
  ...
  38:	53                   	push   %ebx
  39:	e8 95 03 00 00       	call   3d3 <settickets>
  3e:	83 c4 10             	add    $0x10,%esp
  41:	85 c0                	test   %eax,%eax
  43:	0f 85 8d 00 00 00    	jne    d6 <main+0xd6>
...
static void burn(int n){ for(int i=0;i<n;i++) sink += i; }
  ...
  68:	8b 15 00 0b 00 00    	mov    0xb00,%edx
  6e:	01 c2                	add    %eax,%edx
  70:	83 c0 01             	add    $0x1,%eax
  73:	89 15 00 0b 00 00    	mov    %edx,0xb00
  ...
  85:	50                   	push   %eax
  86:	50                   	push   %eax
  87:	68 ee 07 00 00       	push   $0x7ee
  8c:	6a 01                	push   $0x1
  8e:	e8 ed 03 00 00       	call   480 <printf>
  exit();
  93:	e8 9b 02 00 00       	call   333 <exit>
  if(argc == 2) t = atoi(argv[1]);
  98:	83 ec 0c             	sub    $0xc,%esp
  9b:	ff 70 04             	push   0x4(%eax)
  9e:	e8 1d 02 00 00       	call   2c0 <atoi>
  a3:	89 c3                	mov    %eax,%ebx
  if(settickets(0) == 0){
  a5:	31 c0                	xor    %eax,%eax
  a7:	89 04 24             	mov    %eax,(%esp)
  aa:	e8 24 03 00 00       	call   3d3 <settickets>
  af:	83 c4 10             	add    $0x10,%esp
  b2:	85 c0                	test   %eax,%eax
  b4:	75 13                	jne    c9 <main+0xc9>
    printf(1, "FAIL: settickets(0) should fail\n");
  b6:	50                   	push   %eax
  b7:	50                   	push   %eax
  b8:	68 88 07 00 00       	push   $0x788
  bd:	6a 01                	push   $0x1
  bf:	e8 bc 03 00 00       	call   480 <printf>
    exit();
  c4:	e8 6a 02 00 00       	call   333 <exit>
  if(t >= 1 && settickets(t) != 0){
  c9:	85 db                	test   %ebx,%ebx
  cb:	0f 8e 78 ff ff ff    	jle    49 <main+0x49>
  d1:	e9 5f ff ff ff       	jmp    35 <main+0x35>
    printf(1, "FAIL: settickets(%d) should succeed\n", t);
  d6:	51                   	push   %ecx
  d7:	53                   	push   %ebx
  d8:	68 ac 07 00 00       	push   $0x7ac
  dd:	6a 01                	push   $0x1
  df:	e8 9c 03 00 00       	call   480 <printf>
    exit();
  e4:	e8 4a 02 00 00       	call   333 <exit>
  e9:	66 90                	xchg   %ax,%ax
  eb:	66 90                	xchg   %ax,%ax
  ed:	66 90                	xchg   %ax,%ax
  ef:	90                   	nop
 ...
 3e8:	89 d1                	mov    %edx,%ecx
{
 ...
 41b:	0f b6 92 60 08 00 00 	movzbl 0x860(%edx),%edx
 ...
 489:	8b 75 0c             	mov    0xc(%ebp),%esi
{
 ...
 4f4:	ff 24 85 08 08 00 00 	jmp    *0x808(,%eax,4)
 ...
 600:	b8 28 00 00 00       	mov    $0x28,%eax
          s = "(null)";
 605:	bb 01 08 00 00       	mov    $0x801,%ebx
 ...
 611:	a1 04 0b 00 00       	mov    0xb04,%eax
{
 ...
 64f:	5b                   	pop    %ebx
  freep = p;
 650:	a3 04 0b 00 00       	mov    %eax,0xb04
}
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
 657:	5d                   	pop    %ebp
 ...
 666:	72 ce                	jb     636 <free+0x26>
{
 ...
 687:	03 53 fc             	add    -0x4(%ebx),%edx
  freep = p;
 68a:	a3 04 0b 00 00       	mov    %eax,0xb04
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 04 0b 00 00    	mov    0xb04,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6eb:	3b 05 04 0b 00 00    	cmp    0xb04,%eax
 ...
 70e:	e8 fd fe ff ff       	call   610 <free>
  return freep;
 713:	8b 15 04 0b 00 00    	mov    0xb04,%edx
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 73f:	89 15 04 0b 00 00    	mov    %edx,0xb04
}
 ...
 74f:	c3                   	ret
    base.s.ptr = freep = prevp = &base;
 750:	c7 05 04 0b 00 00 08 	movl   $0xb08,0xb04
 757:	0b 00 00 
    base.s.size = 0;
 75a:	b8 08 0b 00 00       	mov    $0xb08,%eax
    base.s.ptr = freep = prevp = &base;
 75f:	c7 05 08 0b 00 00 08 	movl   $0xb08,0xb08
 766:	0b 00 00 
    base.s.size = 0;
 769:	c7 05 0c 0b 00 00 00 	movl   $0x0,0xb0c
 770:	00 00 00 
    if(p->s.size >= nunits){
